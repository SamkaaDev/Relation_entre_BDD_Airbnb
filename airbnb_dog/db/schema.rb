...
ActiveRecord::Schema.define(version: 2019_08_01_102932) do
  ...
  create_table "dog_for_strolls", force: :cascade do |t|
    t.integer "stroll_id"
    t.integer "dog_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_dog_for_strolls_on_dog_id"
    t.index ["stroll_id"], name: "index_dog_for_strolls_on_stroll_id"
  end
